modAds.grid.Applicants = function (config) {
	config = config || {};
	if (!config.id) {
		config.id = 'modads-grid-applicants';
	}
	Ext.applyIf(config, {
	...
	modAds.grid.Applicants.superclass.constructor.call(this, config);
...
Ext.extend(modAds.grid.Applicants, MODx.grid.Grid, {
	windows: {},
	...
	createItem: function (btn, e) {
		var w = MODx.load({
			xtype: 'modads-item-window-create',
			id: Ext.id(),
			listeners: {
				success: {
					fn: function () {
...
Ext.reg('modads-grid-applicants', modAds.grid.Applicants);